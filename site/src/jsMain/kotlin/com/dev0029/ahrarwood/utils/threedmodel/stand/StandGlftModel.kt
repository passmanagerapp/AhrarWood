package com.dev0029.ahrarwood.utils.threedmodel.stand
...
fun setupStandGlftModel(
    ...
    loader.load(
        ...
        { obj ->
            ...
            val scale = 10.0 / maxDim  // Adjust this value to make model larger/smaller
